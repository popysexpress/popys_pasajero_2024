...
class S {
  ...
  String get tWelcomedescription {
    return Intl.message(
      'Live a better experience to share.',
      name: 'tWelcomedescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get tSingIndescription {
    return Intl.message(
      'Enter your details to access',
      name: 'tSingIndescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get tSingUpdescription {
    return Intl.message(
      'Enter your details to create a account',
      name: 'tSingUpdescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get tSingUpTextDescription {
    return Intl.message(
      'Do you not have an account? ',
      name: 'tSingUpTextDescription',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Create one `
  String get tSingUpTextCreate {
    return Intl.message(
      'Create one ',
      name: 'tSingUpTextCreate',
      desc: '',
      args: [],
    );
  }
  ...
  String get tSingInTextDescription {
    return Intl.message(
      'Do you already have an account? ',
      name: 'tSingInTextDescription',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Log in `
  String get tSingInTextCreate {
    return Intl.message(
      'Log in ',
      name: 'tSingInTextCreate',
      desc: '',
      args: [],
    );
  }
  ...
  /// `  About Info`
  String get tAboutInfo {
    return Intl.message(
      'Este software se distribuye bajo la licencia de POPYS EXPRESS S.R.L. \n\nEstá disponible en | GOOGLE PLAY | APPLE STORE | POPYS EXPRESS S.R.L (CHEAP). \n\nAl crear una cuenta, aceptas nuestras Póliticas de Privacidad de los Términos de Servicio. \n\nwww.cheap.popysexpress.com',
      name: 'tAboutInfo',
      desc: '',
      args: [],
    );
  ...
  /// ` About Power By`
  String get tAboutPowerBy {
    return Intl.message(
      'About Power By POPYS EXPRESS S.R.L.',
      name: 'tAboutPowerBy',
      desc: '',
      args: [],
    );
  ...
  String get lButtonSheetAddress {
    return Intl.message(
      'Where do you go today?',
      name: 'lButtonSheetAddress',
      desc: '',
      args: [],
    );
  }
  ...
  String get lFavoriteDestination {
    return Intl.message(
      'Favorite Destinations',
      name: 'lFavoriteDestination',
      desc: '',
      args: [],
    );
  }
  ...
  String get lChooseDestination {
    return Intl.message(
      'Choose your destination',
      name: 'lChooseDestination',
      desc: '',
      args: [],
    );
  }
